...
namespace RapportActionProposer.RCPluginDefinition {
    ...
    public abstract class EffectorPlugin<T> : RCPlugin<T>, IEffectorPlugin where T : class, new() {
    ...
    public abstract class PerceiverPlugin<T> : RCPlugin<T>, IPerceptionReceiverPlugin where T : class, new() {
